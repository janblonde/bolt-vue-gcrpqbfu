export default {
  welcome: {
    greeting: 'Willkommen im Camper-Bereich',
    areaRules: 'Bereichsregeln',
    rules: {
      registration: 'Eine Registrierung vor dem Betreten des Bereichs ist erforderlich.',
      maxStay: 'Maximaler Aufenthalt {nights} aufeinanderfolgende Nächte. (€{price}/Nacht)',
      noise: 'Laute Musik und andere Geräusche sind nicht erlaubt.',
      camping: 'Camping, Grillen oder andere campingähnliche Aktivitäten sind nicht erlaubt.'
    },
  ...
  nights: {
    ...
    nights: 'Nächte',
    maxStay: 'Maximaler Aufenthalt von {nights} Nächten!',
    with: 'mit',
    people: 'Personen',
